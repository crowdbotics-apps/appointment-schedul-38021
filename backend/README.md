...
## Project Structure
    ...
    ├── scheduling_app_temp_38021  # Django project configurations
...
1. Clone this repo and `cd scheduling_app_temp_38021`
...
2. Clone this repo and `cd scheduling_app_temp_38021`
